...
pkg_postinst() {
	xdg-desktop-menu install "${FILESDIR}"/davmail-davmail.desktop || die "Could not register a menu item"
...
pkg_postrm() {
	xdg-desktop-menu uninstall "${FILESDIR}"/davmail-davmail.desktop || die "Could not de-register a menu item"
