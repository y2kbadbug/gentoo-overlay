...
src_prepare() {
	einfo "Bootstrap electron source (This may take awhile)"
	...
	# Bootstrap
	./script/bootstrap.py || die "Bootstrap failed, check your internet connection or logs"
...
src_install() {
	...
	doexe libffmpegsumo.so libnode.so
	doexe ${S}/vendor/brightray/vendor/download/libchromiumcontent/shared_library/libchromiumcontent.so
